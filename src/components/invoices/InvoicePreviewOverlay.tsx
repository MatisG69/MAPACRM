...
export function InvoicePreviewOverlay({ html, filename, onBack, onClose }: InvoicePreviewOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col bg-[#0d0d0d]">
      <div className="flex items-center justify-between px-4 py-3 border-b border-ws-line/60 bg-ws-panel/95 backdrop-blur flex-shrink-0">
        ...
        <span className="text-xs font-mono text-ws-ink uppercase tracking-widest">Aperçu facture</span>
