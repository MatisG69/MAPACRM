          ...
          {MAIN_NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center min-w-[3.25rem] flex-1 max-w-[4.75rem] snap-center rounded-2xl py-1.5 px-1 transition-all duration-300 active:scale-95 touch-manipulation ${
